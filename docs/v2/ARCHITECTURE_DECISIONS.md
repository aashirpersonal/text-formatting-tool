...
| **Unresolved questions** | Exact Next.js minor version and CF adapter at scaffold time; Node vs edge runtime for the OpenAI route; any AI SDK constraints on Workers. |
...
| **Unresolved questions** | Monorepo tool (npm workspaces, pnpm, etc.) chosen at scaffold. |
